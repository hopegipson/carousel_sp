...
!function (t) {
  ...
  window.tram = function (t) {
    ...
    if (z.transition) {
      var M = z.timing.dom;
      if (C.style[M] = f["ease-in-back"][0], !C.style[M]) for (var D in d) {
        f[D][0] = d[D];
      }
    }
    ...
    var I = e.frame = function () {
      ...
      e.init = function (t) {
        ...
        var t;
        this.active || (this.start || (this.start = P()), this.active = !0, t = this, 1 === u.push(t) && I(n));
      }, e.stop = function () {
        var e, n, i;
    ...
    function F(t, e) {
      if (!t.open) {
        ...
        var r = $(t),
            ...
            u = t.el.height(),
            c = t.el[0];
        if (P(0, c), k.intro(0, c), i.redraw.up(), s || d.on("click" + m, t.outside), e) p();else {
